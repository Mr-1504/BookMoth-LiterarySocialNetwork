...
import com.example.postapp.CommentActivity;
import com.example.postapp.HomeFragment;
import com.example.postapp.LikeCountCallback;
...
//        int userId = getCurrentUserId();
    ...
    private void getCurrentLikeCount(int postID, LikeCountCallback callback) {
        ApiClient.getDatabaseApi().getLikeForId("eq." + postID).enqueue(new Callback<Integer>() {
            @Override
