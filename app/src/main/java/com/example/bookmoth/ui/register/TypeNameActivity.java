...
import com.example.bookmoth.ui.viewmodel.registerViewModel.NameViewModel;
...
public class TypeNameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nameViewModel.getFirstName().observe(this, firstName -> {
            Log.i("FIRST NAME", firstName);
        });

        nameViewModel.getLastName().observe(this, lastName -> {
    ...
    private void clickNext() {
        nextButton.setOnClickListener(view -> {
            ...
            if (lastName.length() < 2 || firstName.length() < 2) {
                ...
                nameViewModel.setFirstName(firstName);
                nameViewModel.setLastName(lastName);
