package com.example.bookmoth.core.utils.Api;

import com.example.bookmoth.core.utils.Constant.AppInfo;
import com.example.bookmoth.core.utils.Helper.Helpers;
...
public class CreateOrder {
    ...
    public JSONObject createOrder(String amount, String appUser, String invoiceId) throws Exception {
        ...
        return HttpProvider.sendPost(AppInfo.URL_CREATE_ORDER, formBody, "application/x-www-form-urlencoded");
    }
}
